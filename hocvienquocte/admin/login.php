            ...
            <div class="w3l-form-info">
                <div class="w3_info">
                    ...
                    <form action="login.php" method="post">
                        ...
                        <div>
                            <input class="btn btn-primary btn-block" style="background-color: #8BC6EC;background-image: linear-gradient(135deg, #8BC6EC 0%, #9599E2 100%);" type="submit" value="Đăng Nhập" />
                        </div>
