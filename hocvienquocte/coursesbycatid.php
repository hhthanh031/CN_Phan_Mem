...
<main>
		<div class="top_banner">
			<div class="opacity-mask d-flex align-items-center" data-opacity-mask="rgba(0, 0, 0, 0.3)">
				...
				<?php
				$name_cat = $cat->show_category_fontend_mobile($id);
				if($name_cat){
				...
				<div class="container">
					<div class="d-flex justify-content-center">
						<h1>KHOÁ HỌC : <?php echo $result_name['catName'] ?></h1>
					</div>
				</div>
					...
					<li>
						<div class="sort_select">
							<select name="sort" id="sort" onchange="this.options[this.selectedIndex].value && (window.location = this.options[this.selectedIndex].value);">
                                    ...
                                    <option value="?catid=<?php echo $id ?>&field=coursesId&sort=DESC">Mới nhất</option>
                                    <option value="?catid=<?php echo $id ?>&field=price&sort=ASC">Giá Thấp đến Cao</option>
                                    <option value="?catid=<?php echo $id ?>&field=price&sort=DESC">Giá Cao đến Thấp</option>
							</select>
						</div>
					</li>
					<!-- <li>
				...
				<aside class="col-lg-3" id="sidebar_fixed">
				    <div class="filter_col">
				        ...
				        <div class="filter_type version_2">
				            ...
				            <h4>
				            	<a href="coursesbycatid.php?catid=<?php echo $catid ?>" style="background-color: lightgrey;">
					...
					<div class="row small-gutters">
						...
						<?php
							if(!empty($orderField) && !empty($orderSort)){
								$coursesbycat = $cat->get_courses_by_cat_order($id, $orderField, $orderSort);
								
							}else{
								$coursesbycat = $cat->get_courses_by_cat($id);
							}

							if($coursesbycat){
								while($result = $coursesbycat->fetch_assoc()){
						?>
						...
						<div class="row row_item">
		                    ...
		                    <div class="col-sm-8">
		                        ...
		                        <p>Thời lượng : <?php echo $result['totaltime'] ?></p>

		                        <p>Ngày khai giảng : <?php echo $fm->formatDate1($result['dateedit']) ?></p>
